    ...
    <main className="container mx-auto px-4 py-16">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 mb-24">
        <div className="lg:w-1/2">
          ...
          <Link href="/dasboard">
            <Button size="lg" className="text-lg"> Get Started <ArrowRight className="ml-2 h-5 w-5" /></Button></Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {howItWorks.map((howItWork, index) => {
            return (
              <Card key={index}>
                <CardHeader>
                  <CardTitle className="text-center text-blue-600">{howItWork.step}</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-center text-gray-600">{howItWork.description}</p>
                </CardContent>
              </Card>
